/*! gradient animation*/
{
    ...
    DOM.links = Array.from(document.querySelectorAll('.menu > .menu__item4'));
    ...
    DOM.links.forEach((link, pos) => {
        ...
        anime({
            ...
            complete: () => {
                ...
                link.classList.add('menu__item4--showDeco');
            }
        });
    ...
    const open = (pos) => {
        ...
        anime({
            ...
            begin: () => DOM.links.forEach(link => {
                link.style.pointerEvents = 'none';
                link.classList.remove('menu__item4--showDeco');
            })
        });
        window.open("https://book.chanceyouth.org/","_self")
